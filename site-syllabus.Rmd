...
## EDLD 654: Applied Machine Learning for Educational Data Scientists (CRN: 16924; 3 credit hours)
* **Term:** Fall 2020
* **Time:** 12:15 - 1:45
* **Classroom:** Remote (Zoom)
* **Instructors:** 
	* Joseph Nese, PhD
...
Log into [Canvas](canvas.uoregon.edu) using your DuckID to access the class. If you have questions about accessing and using Canvas, visit the [Canvas support page](https://service.uoregon.edu/TDClient/2030/Portal/Requests/ServiceDet?ID=38635). Canvas and Technology Support also is available by phone (541-346-4357) or [live chat](http://livehelp.uoregon.edu).
...
* Data Quiz (5 points; 2.5%)
* 5 labs at 20 points each (100 points; 50%) 
* Final Project (95 points; 47.5%)
...
#### Description of the data (20 points)
...
#### Description of the models fit (25 points)
